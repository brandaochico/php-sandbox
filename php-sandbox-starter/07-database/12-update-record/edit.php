<?php
  ...
  if($isPutRequest) {
    ...
    $params = ['name' => $name, 'job' => $job, 'id', 'id'];
  ...
  <div class="flex justify-center mt-10">
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
      ...
      <form method="post">
        ...
        <input type="hidden" name="_method" type="<?= $user['id'] ?>">
        <div class="mb-4">
        ...
        <div class="mb-6">
          ...
          <textarea id="job" name="job" placeholder="Enter user job" class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none" value="<?= $user['job'] ?>"></textarea>
        </div>
